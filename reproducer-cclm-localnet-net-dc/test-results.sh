...
## - result - float, the test result, e.g.: network disconnection time in seconds.
## - log - string, the test log result was read from
## Example:
## {
...
##  $ ./test-results.sh 
##
##  $ export LOGS_PATH="$HOME/archive/*/test-results.json"
